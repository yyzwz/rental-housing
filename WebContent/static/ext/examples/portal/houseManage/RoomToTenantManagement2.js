			...
			Ext.apply(config, {
				...
				items : [ {
					...
					items : [ {
						...
						xtype : 'combobox',
						fieldLabel : '来源省',
						id:'RoomToTenantManagement-tenantFromShen',
						store : provinceStore,
						selectOnFocus:false,
						forceSelection: false,
						valueField : 'id',
						...
						listeners : {
							change: function (combo, nv, ov) {
			                    var pid = combo.getValue();
			                    cityStore.removeAll();
			                    //cityStore.clearValue();
			                    var cityCombo=Ext.getCmp('RoomToTenantManagement-tenantFromShi');
			                    cityCombo.reset();
			                    //county.reset();
			                    //alert(pid);
			                    cityStore.add(getChild(pid));
						...
						xtype : 'combobox',
						fieldLabel : '来源市',
						id:'RoomToTenantManagement-tenantFromShi',
						store : cityStore,
						selectOnFocus:false,
						forceSelection: false,
						valueField : 'id',
						...
						listeners : {
							change: function (combo, nv, ov) {
								 var pid = combo.getValue();
								 	countyStore.removeAll();
				                    //countyStore.clearValue();
				                    var xianCombo=Ext.getCmp('RoomToTenantManagement-tenantFromXiani');
				                    xianCombo.reset();
				                    //county.reset();
				                    //alert(pid);
				                    countyStore.add(getChild(pid));
						...
						xtype : 'combobox',
						fieldLabel : '来源县',
						id:'RoomToTenantManagement-tenantFromXiani',
						store : countyStore,
						selectOnFocus:false,
						forceSelection: false,
						valueField : 'id',
