...
//		            },
		    ...
		    var province = Ext.create('Ext.form.ComboBox', {
		    	id:'RoomToTenantManagement-province',
	            displayField: 'text',
	            valueField: 'id',
	            fieldLabel: '省份',
	            labelAlign: 'right',
	        ...
	        var city = Ext.create('Ext.form.ComboBox', {
	        	id:'RoomToTenantManagement-city',
	            displayField: 'text',
	            valueField: 'id',
	            fieldLabel: '城市',
	            labelAlign: 'right',
	        ...
	        var county = Ext.create('Ext.form.ComboBox', {
	        	id:'RoomToTenantManagement-county',
	            displayField: 'text',
	            valueField: 'id',
	            fieldLabel: '区县',
	            labelAlign: 'right',
							...
							if (form.isValid()) {
								...
								Ext.Ajax.request({
									...
									params : {
										...
										tenantFromShen : province.getRawValue(),
										tenantFromShi : city.getRawValue(),
										tenantFromXian : county.getRawValue(),
		...
		initComponent : function() {
			...
			Ext.define('ModelList', {
				...
				fields : [ {
					name : 'id',
					type : 'long'
				}, 'departmentName','departmentId', 'houseId','houseName','tenantIdentify','tenantTel','tenantFromShen','tenantFromShi','tenantFromXian','tenantWorkOrganization','roomId','roomName','tenantId' ,'tenantName', 'descInfo', 'startDate','endDate'  ]
			});
			...
			var columns = [ 
			{
				...
				items : [ {
					...
					handler : function(grid, rowIndex, colIndex) {
						...
						Ext.getCmp("RoomToTenantManagement-province").setRawValue(gridRecord.get('tenantFromShen'));
						Ext.getCmp("RoomToTenantManagement-city").setRawValue(gridRecord.get('tenantFromShi'));
						Ext.getCmp("RoomToTenantManagement-county").setRawValue(gridRecord.get('tenantFromXian'));
						win.show();
					}
